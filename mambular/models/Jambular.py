...
from ..base_models.jambularambular import Jambular
from ..configs.jambular_configambular_config import DefaultJambularConfig


class JambularRegressor(SklearnBaseRegressor):
    """
...
class JambularClassifier(SklearnBaseClassifier):
    """
...
class JambularLSS(SklearnBaseLSS):
    """
